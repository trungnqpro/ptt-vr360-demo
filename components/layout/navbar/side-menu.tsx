  ...
  return (
    <>
      ...
      <Transition show={isOpen}>
        <Dialog onClose={closeSideMenu} className="relative z-50">
          <Transition.Child
            as={Fragment}
          ...
          >
            <Dialog.Panel className="fixed bottom-0 left-0 top-0 flex h-full w-1/4 flex-col bg-white pb-6 dark:bg-black">
              <div className="p-4">
                <button
                ...
                {menu.length ? (
                  <ul className="flex w-full flex-col">
                    {menu.map((item: Menu) => (
                      <li
                        className="py-4 text-xl text-black transition-colors hover:text-neutral-500 dark:text-white"
                        key={item.title}
                      >
                        <Link href={item.path} onClick={closeSideMenu}>
                          {item.title}
                        </Link>
                      </li>
                    ))}
